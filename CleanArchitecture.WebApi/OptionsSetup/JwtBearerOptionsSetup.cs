...
namespace CleanArchitecture.WebApi.OptionsSetup
{
    public sealed class JwtBearerOptionsSetup : IPostConfigureOptions<JwtBearerOptions>
    {
        ...
        public JwtBearerOptionsSetup(IOptions<JwtOptions> jwtOptions)  // burada JwtOptions'u IOptions<> içerisine almak gerekiyor.
        {
            _jwtOptions = jwtOptions.Value;   // burada da nokta value ekledik.
        }
