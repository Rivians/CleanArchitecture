...
namespace CleanArchitecture.Application.Features.CarFeatures.Commands.CreateCar
{
    public sealed class CreateCarCommandValidator : AbstractValidator<CreateCarCommand>
    {
        public CreateCarCommandValidator()
        {
            ...
            RuleFor(p => p.Name).MinimumLength(3).WithMessage("Araç adı en az 3 karakter olamalıdır!");
            ...
            RuleFor(p => p.Name).MinimumLength(3).WithMessage("Araç modeli en az 3 karakter olamalıdır!");
